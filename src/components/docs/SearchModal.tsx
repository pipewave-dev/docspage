                ...
                >
                    ...
                    <div className="flex items-center gap-3 border-b border-slate-700/60 px-4">
                        ...
                        <button
                            ...
                            onClick={onClose}
                            className="shrink-0 rounded-md p-1 text-slate-400 transition-colors hover:bg-slate-700/60 hover:text-white sm:hidden"
                        >
                            <svg
                                className="h-5 w-5"
                                fill="none"
...
function ResultItem({
    ...
    return (
        <li
            ...
            className={`mx-2 cursor-pointer rounded-lg px-3 py-2.5 transition-colors ${isActive ? 'bg-primary-500/15' : 'hover:bg-slate-800/40'
                }`}
        >
