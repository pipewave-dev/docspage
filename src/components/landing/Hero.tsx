    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:py-40">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            A high-performance Go module and TypeScript SDK for real-time
            communication. Binary protocol, user-based messaging, and horizontal
        ...
        <div className="mx-auto mt-16 grid max-w-5xl gap-6 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              <span className="rounded-full bg-primary-500/15 px-3 py-1 text-[11px] font-semibold tracking-wide text-primary-400">
                Frontend
              </span>
              ...
              <div className="rounded-xl border border-slate-800/60 bg-slate-900/50 p-5 backdrop-blur-sm">
                <div className="flex items-center gap-4 text-xs text-slate-500">
                  ...
                  <span className="ml-auto text-[10px] text-slate-600">
                    wrap your app once — point to your server
                  </span>
                </div>
                <div className="mt-4 font-mono text-[13px] leading-relaxed">
                  <div className="flex gap-3">
                    ...
                    <span>
                      ...
                      <span className="text-primary-300">config</span> ={" "}
                  ...
                  <div className="flex gap-3">
                    ...
                    <span className="pl-4">
                      <span className="text-primary-300">backendEndpoint</span>:{" "}
                      <span className="text-green-300">
                        'localhost:8080/pipewave'
                      </span>
                      ,
                    </span>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <span className="pl-4">
                      <span className="text-primary-300">getAccessToken</span>:{" "}
                  ...
                  <div className="flex gap-3">
                    ...
                    <span className="pl-4">
                      ...
                      <span className="text-primary-300">toUserId</span>=
                      <span className="text-green-300">"UserB"</span>{" "}
                      <span className="text-slate-500">/&gt;</span>
                    </span>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <span>
                      <span className="text-slate-500">&lt;/</span>
                      <span className="text-yellow-300">PipewaveProvider</span>
                      <span className="text-slate-500">&gt;</span>
                    </span>
                  </div>
                </div>
          ...
          <div className="flex flex-col gap-3">
            <motion.div
              ...
              className="flex items-center gap-2"
            >
              <span className="rounded-full bg-accent-500/15 px-3 py-1 text-[11px] font-semibold tracking-wide text-accent-400">
                Backend
              </span>
              ...
              <div className="rounded-xl border border-slate-800/60 bg-slate-900/50 p-5 backdrop-blur-sm">
                ...
                <div className="mt-4 font-mono text-[13px] leading-relaxed">
                  <div className="flex gap-3">
                    ...
                    <span>
                      <span className="text-primary-300">pw</span> :={" "}
                      <span className="text-yellow-300">pipewave</span>.
                      <span className="text-yellow-300">NewPipewave</span>(
                      <span className="text-yellow-300">pipewave</span>.
                      <span className="text-yellow-300">PipewaveConfig</span>
                      {"{"}
                    </span>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <span className="pl-4">
                      <span className="text-primary-300">ConfigStore</span>:{" "}
                      <span className="text-orange-300">getConfig</span>(),
                    </span>
                  </div>
                  <div className="flex gap-3">
                    <span className="text-slate-600 select-none w-4 text-right shrink-0">
                    ...
                    <span className="pl-4">
                      ...
                      : <span className="text-yellow-300">ddbRepo</span>.
                      <span className="text-orange-300">NewPostgresRepo</span>,
                    </span>
                  </div>
                  <div className="flex gap-3">
                    <span className="text-slate-600 select-none w-4 text-right shrink-0">
                    ...
                    <span className="pl-4">
                      <span className="text-primary-300">QueueFactory</span>:{" "}
                      <span className="text-yellow-300">queueprovider</span>.
                      <span className="text-orange-300">QueueValkey</span>,
                    </span>
                  </div>
                  <div className="flex gap-3">
                    <span className="text-slate-600 select-none w-4 text-right shrink-0">
                  ...
                  <div className="flex gap-3">
                    ...
                    <span>
                      <span className="text-primary-300">pw</span>.
                      <span className="text-yellow-300">SetFns</span>(&
                      <span className="text-yellow-300">pipewave</span>.
                      <span className="text-yellow-300">FunctionStore</span>
                      {"{"}
                    </span>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <span className="pl-4">
                      <span className="text-primary-300">InspectToken</span>:{" "}
                      <span className="text-orange-300">inspectToken</span>,
                    </span>
                  </div>
                  <div className="flex gap-3">
                    <span className="text-slate-600 select-none w-4 text-right shrink-0">
                    ...
                    <span className="pl-4">
                      <span className="text-primary-300">HandleMessage</span>: &
                      <span className="text-orange-300">handleMsg</span>
                      {"{"}
                      <span className="text-primary-300">i</span>:{" "}
                      <span className="text-primary-300">pw</span>
                      {"}"}
                      {","}
                    </span>
                  ...
                  <div className="flex gap-3">
                    ...
                    <span className="pl-4 text-slate-500">
                      {"// OnNewConnection, OnCloseConnection"}
                    </span>
                  </div>
                  <div className="flex gap-3">
                    <span className="text-slate-600 select-none w-4 text-right shrink-0">
                  ...
                  <div className="flex gap-3">
                    ...
                    <span>
                      <span className="text-primary-300">server</span> := &
                      <span className="text-yellow-300">http</span>.
                      <span className="text-yellow-300">Server</span>
                      {"{"}
                    </span>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <span className="pl-4">
                      <span className="text-primary-300">Addr</span>:{" "}
                      <span className="text-green-300">":8080"</span>,
                    </span>
                  </div>
                  <div className="flex gap-3">
                    <span className="text-slate-600 select-none w-4 text-right shrink-0">
                    ...
                    <span className="pl-4">
                      <span className="text-primary-300">Handler</span>:{" "}
                      <span className="text-yellow-300">http</span>.
                      <span className="text-yellow-300">StripPrefix</span>(
                      <span className="text-green-300">"/pipewave"</span>,{" "}
                      <span className="text-primary-300">pw</span>.
                      <span className="text-yellow-300">Mux</span>()),
                    </span>
                  </div>
                  <div className="flex gap-3">
                    <span className="text-slate-600 select-none w-4 text-right shrink-0">
                  ...
                  <div className="flex gap-3">
                    ...
                    <span>
                      ...
                      <span className="text-primary-300">server</span>.
                      <span className="text-yellow-300">ListenAndServe</span>(){" "}
                  ...
                  <div className="flex gap-3">
                    ...
                    <span>
                      ...
                      <span className="text-primary-300">signalChan</span>{" "}
                      <span className="text-slate-500">
                        {"// wait for SIGTERM"}
                      </span>
                    </span>
                  ...
                  <div className="flex gap-3">
                    ...
                    <span>
                      <span className="text-primary-300">pw</span>.
                      <span className="text-yellow-300">Shutdown</span>(){" "}
                      <span className="text-slate-500">
                        {"// graceful drain"}
                      </span>
                    </span>
