...
const steps = [
  {
    ...
    description:
      "Add the Go backend package and the React frontend SDK to your project.",
    code: `# Backend (Go)
...
npm install @pipewave/reactpkg @msgpack/msgpack`,
  ...
  },
  {
    ...
    title: "Setup Backend",
    description:
      "Create a Pipewave instance, provide InspectToken and HandleMessage, then mount the mux.",
...
http.Handle("/pipewave/", pw.Mux())`,
  ...
  },
  {
    ...
    title: "Wrap Frontend",
    description:
      "Create a PipewaveModuleConfig and wrap your app with PipewaveProvider.",
...
const { status } = usePipewaveStatus()`,
  ...
  },
  {
    ...
    description:
      "Implement HandleMessage to receive client events and push data to any user.",
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <CodeBlock code={step.code} language={step.lang.toLowerCase()} />
              </div>
            </motion.div>
          ))}
        </div>
